...
public class AlbumTaggedPhotosRequest extends KlyphQuery
{
	@Override
	public String getQuery(String id, String offset)
	{
		...
		query += " FROM photo WHERE object_id IN (SELECT object_id FROM photo_tag WHERE subject =  \"" + id + "\")";
		
		query += " LIMIT " + getOffset(offset, "0") + ", 50";
