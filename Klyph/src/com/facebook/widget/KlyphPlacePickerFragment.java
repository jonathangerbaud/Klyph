/**
 * Original code from Facebook
 * Modified to have layout compliant design with Klyph
 * Modified parts :
 *   - KlyphPlacePickerFragment(Bundle args)
 *   - createAdapter()
 *   - onCreateView()
 *   
...
public class KlyphPlacePickerFragment extends PickerFragment<GraphPlace> {
    /**
     ...
     */
    public KlyphPlacePickerFragment() {
        this(null);
    }
     ...
     */
    public KlyphPlacePickerFragment(Bundle args) {
        super(GraphPlace.class, R.layout.fragment_place_picker, args);
    ...
    PickerFragmentAdapter<GraphPlace> createAdapter() {
        ...
        PickerFragmentAdapter<GraphPlace> adapter = new PickerFragmentAdapter<GraphPlace>(
            ...
            protected int getGraphObjectRowLayoutId(GraphPlace graphObject) {
                return R.layout.item_place_picker;
            }
            ...
            @Override
            protected void populateGraphObjectView(View view, GraphPlace graphObject) {
            	//view.setBackgroundResource(AttrUtil.getResourceId(getActivity(), R.attr.listItemSelector));
            	
                //TextView titleView = (TextView) view.findViewById(R.id.com_facebook_picker_title);
                //titleView.setTextColor(AttrUtil.getColor(getActivity(),  android.R.attr.textColorSecondary));
                
                //TextView subtitleView = (TextView) view.findViewById(R.id.picker_subtitle);
                //subtitleView.setTextColor(AttrUtil.getColor(getActivity(),  android.R.attr.textColorTertiary));
                
                super.populateGraphObjectView(view, graphObject);
            }
